...
import { ClipboardList, Heart, Dna, AlertTriangle } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col gap-6 max-w-4xl mx-auto pb-12">
      <div className="flex flex-col gap-1">
        <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-2"><ClipboardList className="w-6 h-6 text-pink-500" /> Historial Clínico y Antecedentes</h2>
      ...
      {cargando ? (
        ...
        <div className="bg-red-50 border border-red-200 text-red-600 rounded-3xl p-6 text-sm text-center flex items-center justify-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-3xl p-6 border border-pink-100/50 shadow-sm flex flex-col gap-4">
            <h3 className="font-bold text-gray-700 text-base flex items-center gap-2">
              <Heart className="w-5 h-5 text-pink-500" /> Ficha Obstétrica
            </h3>
            ...
            <div className="flex items-center gap-2 text-xs text-gray-500 bg-pink-50/20 border border-pink-100/30 p-3 rounded-2xl">
              <Dna className="w-4 h-4 text-pink-400 flex-shrink-0" />
          ...
          <div className="bg-white rounded-3xl p-6 border border-pink-100/50 shadow-sm flex flex-col gap-4">
            <h3 className="font-bold text-gray-700 text-base flex items-center gap-2">
              <ClipboardList className="w-5 h-5 text-blue-500" /> Antecedentes Personales
            </h3>
