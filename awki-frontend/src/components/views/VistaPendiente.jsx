...
const placeholderViews = {
  ...
  historial: {
    icon: <img src='/calendario.png'></img>,
  ...
  ecografias: {
    icon: <img src='/estetoscopio.png'></img>,
  ...
  educacion: {
    icon: <img src='/educacion.png'></img>,
    title: 'Educación',
  ...
  recordatorios: {
    icon: <img src='/notificacion.png'></img>,
    title: 'Recordatorios',
