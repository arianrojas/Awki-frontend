...
const articles = [
  {
    id: 1,
    emoji: <img src='/ensalada.png'></img>,
  ...
  {
    id: 3,
    emoji: <img src="/ejercicio.png"></img>,
  ...
  {
    id: 5,
    emoji: <img src="/estetoscopio.png"></img>,
  ...
  {
    id: 6,
    emoji: <img src="/vitamina.png"></img>,
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
          ...
          <div className="xl:col-span-2 flex flex-col gap-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                { icon: <img src='/calendario.png' alt='logo_calendario'></img>, label: 'Agendar cita', sub: 'Reservar nueva cita', color: 'bg-pink-50 text-pink-600 border-pink-100' },
                { icon: <img src='/control.png'></img>, label: 'Registrar control', sub: 'Añadir nuevo control', color: 'bg-blue-50 text-blue-600 border-blue-100' },
                { icon: <img src='/peso.png'></img>, label: 'Registrar peso', sub: 'Llevar seguimiento', color: 'bg-green-50 text-green-600 border-green-100' },
                { icon: <img src='/notificacion.png'></img>, label: 'Recordatorios', sub: 'Ver mis alertas', color: 'bg-amber-50 text-amber-600 border-amber-100' },
              ].map((a) => (
